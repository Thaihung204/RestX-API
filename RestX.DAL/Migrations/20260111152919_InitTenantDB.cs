        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BenefitDescription = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LoyaltyPointBands", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    AutoDisableByStock = table.Column<bool>(type: "bit", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ModifiedBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxStockLevel = table.Column<decimal>(type: "decimal(10,3)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ComboDetails_MealCombos_ComboId",
                        column: x => x.ComboId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PromotionApplicableItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PromotionApplicableItems_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PromotionApplicableItems_Dishes_DishId",
                        column: x => x.DishId,
                        principalTable: "Dishes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PromotionApplicableItems_MealCombos_ComboId",
                        column: x => x.ComboId,
                        principalTable: "MealCombos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PositionX = table.Column<decimal>(type: "decimal(8,2)", nullable: false),
                    PositionY = table.Column<decimal>(type: "decimal(8,2)", nullable: false),
                    ...
                    Has3DView = table.Column<bool>(type: "bit", nullable: false),
                    ViewDescription = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    DefaultViewUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DishRecipes", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DishRecipes_Ingredients_IngredientId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModelFormat = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    EnvironmentMapUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    BackgroundColor = table.Column<string>(type: "nvarchar(7)", maxLength: 7, nullable: false),
                    CameraX = table.Column<decimal>(type: "decimal(8,4)", nullable: false),
                    CameraY = table.Column<decimal>(type: "decimal(8,4)", nullable: false),
                    CameraZ = table.Column<decimal>(type: "decimal(8,4)", nullable: false),
                    CameraFOV = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    AllowRotation = table.Column<bool>(type: "bit", nullable: false),
                    AllowZoom = table.Column<bool>(type: "bit", nullable: false),
                    MinZoom = table.Column<decimal>(type: "decimal(4,2)", nullable: false),
                    MaxZoom = table.Column<decimal>(type: "decimal(4,2)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ModifiedBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Table3DModels", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Table3DModels_Tables_TableId",
                        column: x => x.TableId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Orders_Employees_HandledBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CashReceive = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_Employees_ProcessedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PromotionHistories_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DishRecipes_IngredientId",
                table: "DishRecipes",
                column: "IngredientId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeSchedules_EmployeeId_WorkDate",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LoyaltyPointBands_Min_Max",
                table: "LoyaltyPointBands",
                columns: new[] { "Min", "Max" });

            migrationBuilder.CreateIndex(
                name: "IX_MealCombos_Code",
                table: "MealCombos",
                column: "Code",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PointsTransactions_CustomerId_CreatedDate",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PromotionApplicableItems_CategoryId",
                table: "PromotionApplicableItems",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_PromotionApplicableItems_ComboId",
                table: "PromotionApplicableItems",
                column: "ComboId");

            migrationBuilder.CreateIndex(
                name: "IX_PromotionApplicableItems_DishId",
                table: "PromotionApplicableItems",
                column: "DishId");

            migrationBuilder.CreateIndex(
                name: "IX_PromotionApplicableItems_PromotionId",
                table: "PromotionApplicableItems",
                column: "PromotionId");

            migrationBuilder.CreateIndex(
                name: "IX_PromotionHistories_OrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockTransactions_IngredientId_CreatedDate",
                table: "StockTransactions",
                columns: new[] { "IngredientId", "CreatedDate" });

            migrationBuilder.CreateIndex(
                name: "IX_Table3DModels_TableId",
                table: "Table3DModels",
                column: "TableId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TableSessions_TableId_IsActive",
                table: "TableSessions",
