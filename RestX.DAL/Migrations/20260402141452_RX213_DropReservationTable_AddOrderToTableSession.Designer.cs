...
namespace RestX.DAL.Migrations
{
    ...
    [Migration("20260402141452_RX213_DropReservationTable_AddOrderToTableSession")]
    partial class RX213_DropReservationTable_AddOrderToTableSession
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestX.Models.AI.AIChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RestX.Models.Tables.Table", b =>
                {
                    ...
                    b.Property<string>("CubeBackImageUrl")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("CubeBottomImageUrl")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("CubeFrontImageUrl")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("CubeLeftImageUrl")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("CubeRightImageUrl")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("CubeTopImageUrl")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("RestX.Models.AI.AIChatMessage", b =>
                {
                    b.HasOne("RestX.Models.AI.AIChatSession", "Session")
                        .WithMany("Messages")
